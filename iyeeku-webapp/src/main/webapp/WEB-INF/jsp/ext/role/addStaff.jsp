...
<body>
    ...
    <div class="mini-fit">
        <div id="datagrid1" datafld="data" class="mini-datagrid" style="width:100%;height:100%;" borderStyle="border-left:0;border-bottom:0;border-right:0;" sortMode="client"
            url="${pageContext.request.contextPath}/role/listNotAddedStaff" multiSelect="true"
...
<script type="text/javascript">
    ...
    function onOk() {
        ...
        mini.confirm("确定是否给当前用户授予角色？", "确定？",
            function (action) {
                if (action == "ok") {
                    $.ajax({
                        url: "${pageContext.request.contextPath}/role/comfirmAddStaff",
                        type: "post",
